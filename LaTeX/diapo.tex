...
\end{beamerboxesrounded}
    ...
    \[ \longleftrightarrow \]
    \[ z: [-\pi,\pi] \rightarrow \mathbb{C} \text{ de classe $C^1$ tel que $z(-\pi)=z(\pi)$ et $|z'| \equiv 1$} \]
...
\begin{frame}{Suite de la preuve (7/7)}
    ...
    Nous avons prouver que le problème admet des solutions et quelles correspondent seulement à l'image réciproque de la bijection de $c_0+c_1e_1$ (avec $c_0$ et $c_1$ $\in \mathbb{C}$ tel que $|c_1|=1$) soit un \textbf{cercle}.
\end{frame}
